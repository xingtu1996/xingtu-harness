***REMOVED*** XingTu Harness · 一线 AI 工程化脚手架
...
***REMOVED******REMOVED*** 🧩 与 DeepSeek Harness（DSH）的关系
...
***REMOVED******REMOVED******REMOVED*** 方式一：一键拉全（推荐）
...
***REMOVED******REMOVED******REMOVED*** 方式二：按场景安装

```bash
***REMOVED*** 查看可用场景
./harness list

***REMOVED*** 只装某个场景（例：微服务项目）
./harness install scene:microservice
```

***REMOVED******REMOVED*** 🧩 场景矩阵（按领域开箱即用）
